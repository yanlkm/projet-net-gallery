...
<div class="wrapper row2">
  <section id="ctdetails" class="hoc container clear"> 
    ...
    <div class="sectiontitle">
      ...
      <h6 class="heading font-x2">ERREUR DANS LA CREATION</h6>
...
$mdp1=addslashes(htmlspecialchars($_POST['motdp1']));
        ...
        if ($mdp<>$mdp1)
        {
          ...
          echo("<button class='btn' onclick=location.href='admin_ticket.php'> Retour à Gestion Tickets </button>");
        ...
        else
        {
                ...
                {$req1="INSERT into t_visiteur_vis values (NULL,'".$mdp1."',NULL,NULL,'".$_SESSION['login']."',NOW(),NULL)";
